...
function wp_website_scripts() {
  $version = $_SERVER['HTTP_HOST'] == 'localhost' ? 'v' . rand() : '1.0';
	if($_SERVER['HTTP_HOST'] == 'localhost') {
		wp_enqueue_style('main_css', 'http://localhost:3000/build/style.css', array(), $version, false);
		wp_enqueue_script('main_js', 'http://localhost:3000/build/app_bundle.js', array(), $version, true);
	} else {
